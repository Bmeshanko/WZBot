...
namespace WarLight.Shared.AI.Prime.Orders
{
    static class ExpansionWeight
    {
        ...
        public static int ArmiesToTake(TerritoryIDType terrID, Main.PrimeBot bot)
        {
        ...
        public static int BonusCompletionWeight(Main.PrimeBot Bot, BonusIDType bonusID) 
        {
            int numArmies = 0;
        ...
        public static float Weigh(Main.PrimeBot Bot, TerritoryIDType terrID, BonusIDType bonusID, int turnsToTake)
        {
            float weight = 1000f;
